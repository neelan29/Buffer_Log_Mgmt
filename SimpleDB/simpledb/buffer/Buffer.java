...
public class Buffer {
   ...
   private BasicBufferMgr basicBufferMgr = null;
   ...
   public void setBufferMgr(BasicBufferMgr basicBufferMgr) {
	   this.basicBufferMgr = basicBufferMgr;
   }
   ...
   public void setInt(int offset, int val, int txnum, int lsn) {
      ...
      basicBufferMgr.updateBufferPool(this);
   }
